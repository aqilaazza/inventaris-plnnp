...
class _KalenderRiwayatPopupState extends State<_KalenderRiwayatPopup> {
  ...
  // jadi tidak lagi menarik ribuan baris riwayat sekaligus.
  ...
  // ============================================================
  // Detail popup — sama persis fungsinya dengan yang ada di halaman
  // "Aktivitas Terbaru" (riwayat_screen.dart), supaya klik card di
  // kalender juga bisa lihat detail lengkap (kategori, merk, lokasi,
  // catatan, review, foto bukti, dst).
  // ============================================================
