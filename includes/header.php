...
<head>
    ...
    <title><?= $page_title ?? 'Dashboard' ?> | Admin Inventaris</title>
    <meta name="description" content="Sistem Informasi Inventaris Barang - Panel Admin">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" style="font-size:13px; font-weight:500; color:#374151;">
                    <i class="fas fa-user-circle mr-1" style="font-size:16px; color:#6366f1;"></i>
